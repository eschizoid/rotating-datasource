...
/**
 * Load test to ensure the Apache DBCP2 pool is not exhausted under concurrent queries and there are
 * no leaks.
 */
...
public class ConnectionLoadTest {
  ...
  private static final String SECRET_ID = "db/secret-load-dbcp2";
