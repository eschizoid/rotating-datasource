...
public class App {
  ...
  public App(
    ...
    this.client = new DbClient(new RotatingDataSource(secretId, factory, refreshIntervalSeconds));
  }

  /**
   * Entry point. Builds an App using the HikariCP factory from Pool and prints the DB time.
   *
  ...
  public static void main(String[] args) throws Exception {
    ...
    final var app = new App("mydb/secret", Pool.hikariFactory);
